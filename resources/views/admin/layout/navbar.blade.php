        ...
        <nav class="navbar navbar-expand-xl navbar-dark fixed-top hk-navbar">
                ...
                <a class="navbar-brand" href="index.html">
                    <img class="brand-img d-inline-block" src="{{asset('admin/dist/img/logo-dark.png')}}" alt="mocharasa" />
                </a>
					...
					<li class="nav-item dropdown dropdown-authentication">
						<a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<div class="media">								
								<div class="media-body">
									<span>Hi,&nbsp;<strong>{{ Auth::user()->name }}</strong><i class="zmdi zmdi-chevron-down"></i></span>
								</div>
							</div>
						</a>
						<div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
							...
							<div class="dropdown-divider"></div>							
							<a class="dropdown-item" title="Log Out" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
