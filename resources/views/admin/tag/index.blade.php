...
@section('content')
    ...
    <div class="container-fluid px-xxl-65 px-xl-20">
      <div class="row">
        <div class="col-xl-12">
          <a href="{{ route('tag.create')}}" class="btn btn-info btn-sm float-right text-white my-1 py-1"><i class="fa fa-plus-square"></i> Tambah Data</a>
        </div>
      </div>
      <div class="row">
        <div class="col-xl-12">
                              <section class="hk-sec-wrapper">
                                  <h5 class="hk-sec-title">Data Tag</h5>
                                  <div class="row">
                                      <div class="col-sm">
                                          <div class="table-wrap">
                                              <table class="table tablesaw table-bordered table-hover  mb-0" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                                                  <thead>
                                                      <tr>
                                                          ...
                                                          <th scope="col" data-tablesaw-sortable-col><h6 class="text-center">Nama Tag</h6></th>
                                                          <th scope="col" data-tablesaw-sortable-col></th>
                                                      </tr>
                                                  </thead>
                                                  <tbody>
                                                    @foreach ($tags as $row=>$hasil)
                                                      <tr>
                                                          <td><center>{{ $row + $tags->firstitem() }}</center></td>
                                                          <td><a href="javascript:void(0)">{{$hasil->name}}</a></td>
                                                          <td class="text-center py-0 my-0">
                                                            <a href="{{route('tag.edit', $hasil->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                                              ...
                                              <div class="my-1 py-1 float-right">{{ $tags->links() }}</div>
                                          </div>
                                      </div>
                                  </div>
                              </section>
